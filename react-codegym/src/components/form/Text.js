    ...
    <div className="container pt-3">
      ...
      >
        <Form>
          ...
          <button type="submit" className="mb-4 btn btn-success me-2">
            {mode.action}
          </button>
          <button type="reset" className="mx-2 mb-4 btn btn-secondary">
            Reset
          </button>
        </Form>
      </Formik>
      <table className="table pt-3 table-hover table-bordered table-striped">
        <thead>
          <tr>
            <th>Tiêu đề</th>
            <th>Tác giả</th>
